...
def create_alert(channel, req_data):
    ...
    try:
        res, debug_msg = t.actors.send_message(_x_tapis_tenant=g.tenant_id, _x_tapis_user=g.username, actor_id=actor_id, message= json.dumps(message_data), request_body=message_data,headers={'X-Tapis-Tenant': g.tenant_id},_tapis_debug=True)
