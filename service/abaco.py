...
def create_alert(channel, req_data):
    ...
    try:
        res, debug_msg = t.actors.send_message(_tapis_set_x_headers_from_service=True, actor_id=actor_id, message= json.dumps(message_data), request_body=message_data,headers={'X-Tapis-Tenant': g.tenant_id},_tapis_debug=True)
